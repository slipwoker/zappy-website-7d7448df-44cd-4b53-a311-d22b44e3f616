document.addEventListener('DOMContentLoaded', function () {
  ...
  const ANIMATE_CLASS = 'fade-in-animate';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Tamar Nails משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '7d7448df-44cd-4b53-a311-d22b44e3f616',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '7d7448df-44cd-4b53-a311-d22b44e3f616';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '7d7448df-44cd-4b53-a311-d22b44e3f616';
